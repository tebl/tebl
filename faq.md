...
As already mentioned in [Are you on YouTube?](https://github.com/tebl/tebl/edit/main/faq.md#13-are-you-on-youtube) I have a [channel](https://www.youtube.com/@TEBLify), it has videos that were made to serve as documentation rather than focus on editing and, well, presentability in general. I would love it if you were to make a video sharing something that I've had a hand in designing - I'm sure you can do a significantly better job at presenting it! While I do stumble across from time to time, it is somewhat strange to do so several months after the rest of the audience have seen it.

I do wish that you include links to my channel if you are able to, but for the viewers in general a link to the specific GitHub-repository is probably helpful - if only so that people will be able to find their way to the latest available documentation.

## 1.5> Can I sell these?
Yes, but only as long as you agree to stay within the limitations of the license supplied with the specific project. That's pretty much it, and while I don't expect you to sit down and read the whole things - the short summary of the licenses that I use is mostly that I am not able to provide any warranties. At least beyond it having worked that one time I built one. Considering my health don't, but also the fact that you would then be the seller in any case - you should be prepared to support the products you sell. I can't dictate what you would charge for something, therefore I simply ask that you don't charge more than what can reasonably be considered appropriate - depending on the amount of time you spend building it, as well as the cost of components used to put one together.
